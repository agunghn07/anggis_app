...
class Mailer {
    protected $_ci;
    protected $email_pengirim = 'soulsister119@gmail.com'; // Isikan dengan email pengirim
    protected $nama_pengirim = 'Sistem Cuti App'; // Isikan dengan nama pengirim
    protected $password = 'smkqtatwrgxgvyhj'; // Isikan dengan password email pengirim
    ...
    public function send($data){
        ...
        // $mail->AddEmbeddedImage('assets/img/stack-logo-dark.png', 'logo_app', 'stack-logo-dark.png'); // Aktifkan jika ingin menampilkan gambar dalam email
        $send = $mail->send();
