              ...
              <script type="text/javascript" src="<?php echo base_url(); ?>assets/js/proses/lesson.js"></script>
                <div class="row wrapper border-bottom white-bg page-heading">
                    <div class="col-lg-10">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <strong>Daftar Pelajaran</strong>
                            </li>
                        </ol>
                    </div>
                    <div class="col-lg-2">
                          ...
                          <div class="ibox float-e-margins">
                            <div class="panel panel-default">
                              <div class="panel-heading">
                                <h3 class="panel-title">Daftar Pelajaran</h3>
                              </div>
                              <div class="panel-body">
                                <div class=""> 
                                  <form id="form" action="#" method="POST" style="padding-bottom: 50px;">
                                    ...
                                    <div class="form-group">
                                      <div class="col-md-4 col-sm-4 col-xs-12">
                                        <label class="control-label col-md-8 col-sm-8 col-xs-12">Nama Mapel</label>
                                        <input type="hidden" name="id_lesson" id="id_lesson">
                                        <input type="text" name="lesson_name" id="lesson_name" class="form-control" placeholder="Nama Pelajaran">
                                  ...
                                  <div class="table-responsive" style="margin-left: 25px; margin-right: 25px;">
                                    <table id="lesson" class="table table-striped table-bordered table-hover" width="100%" align="center">
                                      <thead>
                                        <tr>
                                          <th>No</th>
