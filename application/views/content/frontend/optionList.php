	...
	<tr>
		...
		<td style="width:90%">
			<div class="row">
				...
				<?php if ($vOption->option_image != ''): ?>
					<div class="col-sm-3">
						<a href="<?= base_url('assets/img/assignments/'.$dataAssignment->assignment_path.'/'.$vOption->option_image) ?>" target="_blank"><img src="<?= base_url('assets/img/assignments/'.$dataAssignment->assignment_path.'/'.$vOption->option_image) ?>" class="img-thumbnail img-responsive">
						</a>
					</div>
				<?php endif ?>
			</div><!-- / Row -->
