<script type="text/javascript">
	...
	$(document).ready(function() {
	    ...
	    table = $('#lesson').DataTable({ 
	        ...
	        "ajax": {
	            "url": "<?php echo site_url('backend/Lesson/daftar_pelajaran')?>",
	            "type": "POST"
	        },
	    ...
	    $("#form").unbind('submit').bind('submit', function() {
	        ...
	        $.ajax({
	            ...
	            url: "<?php echo site_url('backend/Lesson/add_mapel')?>",
	...
	function edit(id){
	    ...
	    $.ajax({
	        url : "<?php echo site_url('backend/Lesson/get_mapel/')?>/" + id,
	        type: "GET",
	        dataType: "JSON",
	...
	function update()
	{
	    ...
	    url = "<?php echo site_url('backend/Lesson/update_mapel')?>";
	...
	function hapus(id){
        ...
        function(isConfirm) {
          if (isConfirm) {
            $.ajax({
                    url : "<?php echo site_url('backend/Lesson/hapus_mapel')?>/"+id,
                    type: "POST",
                    dataType: "JSON",
                    success: function(data)
                    {
