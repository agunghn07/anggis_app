...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 30 Jul 2020 pada 03.51
...
('Adm/DUTI/1', 'Administator', 'Admin', 'M', 1, 'DUTI', 'noimage.png', NULL, '2020-07-23 20:03:32', 'Admin', '2020-07-29 07:30:29', 'Admin'),
...
('Emp/DI/4', 'Ayu Fitriani', 'Ayu', 'F', 3, 'DI', 'noimage.png', 'Emp/DI/1', '2020-07-29 10:00:26', NULL, NULL, NULL),
('Emp/DI/5', 'Natasya Amelia Apriliani', 'Natasya', 'F', 4, 'DI', 'noimage.png', 'Emp/DI/4', '2020-07-29 10:01:09', NULL, '2020-07-29 10:01:34', 'Admin'),
('Emp/DK/1', 'Reddy Orlan Ibrahim', 'Reddy', 'M', 2, 'DK', 'noimage.png', NULL, '2020-07-29 09:53:50', NULL, NULL, NULL),
('Emp/DK/2', 'Ibnu Satria', 'Ibnu', 'M', 4, 'DK', 'noimage.png', 'Emp/DK/1', '2020-07-29 09:56:52', NULL, NULL, NULL),
('Emp/DK/3', 'Bayu Rizki Darmawan', 'Bayu', 'M', 4, 'DK', 'noimage.png', 'Emp/DK/1', '2020-07-29 09:59:14', NULL, NULL, NULL),
...
('Emp/DKPP/3', 'Rian Subagyo', 'RianS', 'M', 4, 'DKPP', 'noimage.png', 'Emp/DKPP/1', '2020-07-23 21:38:00', 'Admin', '2020-07-29 10:34:50', 'Admin'),
('Emp/DKPP/4', 'Bima Fatahilah', 'Bima', 'M', 4, 'DKPP', 'noimage.png', 'Emp/DKPP/5', '2020-07-28 10:25:17', NULL, '2020-07-29 10:33:53', 'Admin'),
...
('Emp/DUTI/5', 'Rian Subhanhadi', 'Rian', 'M', 4, 'DUTI', 'pexels-photo-220453.jpeg', 'Emp/DUTI/7', '2020-07-23 20:42:37', 'Admin', '2020-07-29 07:36:16', 'Rian'),
('Emp/DUTI/6', 'Rianto Anggara', 'Rianto', 'M', 4, 'DUTI', 'noimage.png', 'Emp/DUTI/2', '2020-07-28 09:31:21', NULL, '2020-07-29 10:00:18', 'Admin'),
...
ALTER TABLE `tb_t_cuti`
  ADD PRIMARY KEY (`ID`),
  ADD KEY `FK_tb_t_cuti_EMP_NOREG` (`EMP_NOREG`);
...
--
ALTER TABLE `tb_r_token`
  MODIFY `id_token` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;
